...
#it would appear in my version of powershell - 5.1.17134.112 -  this command does 
# not exist
# so i guess i do not get "v2 mode" which I likely don't need any way
#Add-WindowsFeature powershell-v2
# looks like the first two chapters of this book could just as easily have 
# been an intro chapter 
